...
import { type IconComponent, type IconLibrary, type IconName, iconLibraryOrder, iconMap } from "@ziron/ui/lib/icon-map";

// Re-export types for consumers
export type { IconComponent, IconLibrary, IconName } from "@ziron/ui/lib/icon-map";
export { iconLibraryLabels, iconLibraryOrder } from "@ziron/ui/lib/icon-map";
...
function IconProvider({ children, defaultLibrary = "lucide" }: { children: ReactNode; defaultLibrary?: IconLibrary }) {
	...
	return <IconContext.Provider value={{ iconLibrary, setIconLibrary }}>{children}</IconContext.Provider>;
}
