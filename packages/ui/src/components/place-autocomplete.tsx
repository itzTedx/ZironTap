...
import { Command, CommandEmpty, CommandGroup, CommandItem, CommandList } from "@ziron/ui/components/command";
		...
		<Command className={cn("h-fit overflow-visible", className)} loop shouldFilter={false}>
			<div className="relative">
				...
				{showCommandList && (
					<CommandList
						className={cn(
							"absolute top-full right-0 left-0 rounded-b-md border border-input border-t-0 bg-popover shadow-md",
