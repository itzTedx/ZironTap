...
interface QRCodeCanvasProps extends React.ComponentProps<"canvas">, useRender.ComponentProps<"canvas"> {}
...
interface QRCodeDownloadProps extends React.ComponentProps<"button">, useRender.ComponentProps<"button"> {
	filename?: string;
	format?: "png" | "svg";
}

function QRCodeDownload(props: QRCodeDownloadProps) {
	const { filename = "qrcode", format = "png", render, className, children, ...buttonProps } = props;
...
interface QRCodeSkeletonProps extends React.ComponentProps<"div">, useRender.ComponentProps<"div"> {}
