...
### Accessibility
- [ ] Add accessibility checklist to `README.md`
- [ ] Install ESLint plugin: `eslint-plugin-jsx-a11y`
- [ ] Add runtime testing: `axe-core`
- [ ] Define global rules:
...
### Accessibility
- [ ] Add optional fields:
  - `altText` (for images/media)
  - `ariaLabel` (if needed for templates)
- [ ] Ensure slugs are readable and meaningful
...
- [ ] Implement security measures like Rate Limiting, Input Sanitization, Source Map Security [Ref: Security Design System](https://optics.agusmayol.com.ar/resources/security)

### Accessibility
- [ ] All inputs have `<label>`
- [ ] Errors linked via `aria-describedby`
- [ ] Keyboard navigation works بالكامل
- [ ] Focus moves to errors on submit
- [ ] No keyboard traps
- [ ] Accessible CAPTCHA if introduced
...
- [ ] Implement accessible bio editor using ProseKit with limited formatting (headings, bold/italic, lists, links); store content as JSON and render as sanitized HTML/MDX in `apps/client`, with keyboard support, aria labels, alt text for media, and validation (length + safe content)
...
- [ ] Icons:
  ...
  - meaningful → labeled
- [ ] Media uploads require alt text
...
- [ ] Accessible labels for actions (call, email, etc.)
...
- [ ] Errors readable and screen-reader friendly
- [ ] Offline indicators use text + icons (not color only)
...
- Dashboard UI Blocks with good UI Charts: https://ui.pacekit.dev/apps/dashboards
- Good Charts: https://evilcharts.com/docs
---
